function [validation_performance,W_in,res_net,W_out,t_validate,x_real,x_validate] = ...
    func_STP_train_NullDim_noise_inv(udata,tp_train_set,dim_set,flag,...
    W_in_type,res_net_type,validation_type,print_progress_type,inv_type)
...
elseif inv_type == 2
    W_out= y_reg *r_reg'*inv(r_reg*r_reg'+beta*eye(n));
elseif inv_type ==3
