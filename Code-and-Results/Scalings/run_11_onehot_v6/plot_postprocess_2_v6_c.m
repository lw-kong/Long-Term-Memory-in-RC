...
len_threshold_new1 = 400;
len_threshold_new2 = 400;

mean(mean(result_pers_set_new1,2),3)
result_pers_set_new2 = result_pers_set_new2 - result_pers_set_new1;
mean(mean(result_pers_set_new2,2),3)

%% rmse
%rmse_val_threshold = 0.05;
