function [validation_performance,W_in,res_net,W_out,t_validate,x_real,x_validate] = ...
    func_STP_train_NullDim_60_GPU(udata,tp_train_set,dim_set,flag,...
...
YR = zeros(dim,n,'gpuArray');
RR = zeros(n,n,'gpuArray');
...
for tp_i = 1:tp_length
    ...
    %y_seg = train_y(1:dim,11:end); % dim, t_block
    %r_seg = r_out; % n, t_block

    YR = YR + train_y(1:dim,11:end)*r_out';
    RR = RR + r_out*r_out';
