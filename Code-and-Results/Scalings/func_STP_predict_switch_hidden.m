function [predict_all,hidden_all] = func_STP_predict_switch_hidden(x_warmup,tp_1,tp_2,W_in,res_net,P,flag)
% included warmup
...
hidden_1 = zeros(predict_length_1,n);
...
hidden_2 = zeros(predict_length_2,n);
u(dim+1:end) = tp_2;
