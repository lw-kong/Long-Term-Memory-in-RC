function [predict,r_all] = func_STP_predict_uniformedST_hidden(x_warmup,tp,W_in,res_net,P,flag)
% included warmup
...
%% predicting
% disp('  predicting...')
r_all = zeros(predict_cut + predict_length,n);
